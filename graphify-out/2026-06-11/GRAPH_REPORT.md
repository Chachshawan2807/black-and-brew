# Graph Report - black-and-brew  (2026-06-11)

## Corpus Check
- 251 files · ~143,054 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1517 nodes · 2248 edges · 116 communities (87 shown, 29 thin omitted)
...
Cohesion: 0.24
Nodes (7): updateInventoryStock(), CountInput(), InventoryItem, InventoryAddItemModal(), InventoryAddItemModalProps, NewInventoryItemInput, ensureSupabaseSession()

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (52): assertWritableSession(), checkAuth(), isReadOnlySession(), dateRangeSchema, ensureAuthorized(), saveRegularHolidays(), supabaseAdmin, syncHolidays() (+44 more)
...
Cohesion: 0.13
Nodes (11): ActionItem, actionItemSchema, InsightBullet, insightBulletSchema, MarketContext, MarketInsightsV2, MomDetail, ScheduleEntry (+3 more)
...
Cohesion: 0.18
Nodes (14): SalesSnapshot, ContextPanel(), ChartTooltip(), PASTEL, QtyTooltip(), fmtCurrency(), fmtCurrencyCompact(), fmtInteger() (+6 more)
...
Cohesion: 0.06
Nodes (51): analyzeCompetitorProfile(), extractFacebookUrl(), isOwnStore(), OWN_STORE_PATTERNS, BRAND_RULES, EXCLUDE_SUBSTRINGS, filterComparableCompetitors(), matchCompetitorSegment() (+43 more)
...
Cohesion: 0.16
Nodes (29): fetchComprehensiveInventoryData(), fetchSupabaseContext(), getMarketInsights(), getSupabaseAdmin(), MODEL, persistRun(), buildCompetitorPromptDigest(), buildAlerts() (+21 more)
...
Cohesion: 0.16
Nodes (10): __clearTrendsCache(), EMPTY_WEATHER, fetchWeatherForecast(), TREND_QUERIES, TrendsResult, HolidayEntry, MarketSource, WeatherContext (+2 more)
...
Cohesion: 0.19
Nodes (12): colorMap, CommandCenterGrid(), iconMap, NavItem, SortableItem, LiveShiftList(), InventoryCountPage(), InventoryQuickActionFAB() (+4 more)
...
Cohesion: 0.12
Nodes (19): InventoryHistoryModal(), InventoryHistoryModalProps, TransactionHistoryRow, TransactionTypeBadge(), FrequentItem, InventoryQuickActionBar(), InventoryQuickActionBarProps, QuickActionItem (+11 more)
...
Cohesion: 0.06
Nodes (33): clearAuth(), getCookieOpts(), verifyPin(), buildDeviceFields(), ensureAuthenticated(), fetchLoginHistory(), LoginAccessLevel, LoginEventStatus (+25 more)
...
- **Why does `cn()` connect `Community 86` to `Community 0`, `Community 3`, `Community 4`, `Community 77`, `Community 81`, `Community 117`, `Community 120`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `assertWritableSession()` connect `Community 4` to `Community 0`, `Community 3`, `Community 7`, `Community 14`, `Community 19`, `Community 117`?**
