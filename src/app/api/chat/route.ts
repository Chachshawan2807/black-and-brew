...
function buildSystemPrompt(
  ...
  const identity = `
คุณคือ "บรู" (Bru) ผู้ช่วยสาวแสนสวยประจำร้านกาแฟ black and brew
...
ชื่อร้าน: black and brew | ที่ตั้ง: ลำลูกกา, ปทุมธานี
...
- เชื่อมโยงกับบริบทของร้านกาแฟ black and brew เสมอ
`.trim());
  }
