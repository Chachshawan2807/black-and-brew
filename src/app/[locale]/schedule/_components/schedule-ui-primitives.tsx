...
export const SCHEDULE_BTN_GHOST =
  'inline-flex items-center justify-center gap-2 h-11 min-h-[44px] px-4 text-[13px] font-normal text-muted-foreground hover:text-foreground hover:bg-muted/30 rounded-2xl bb-transition cursor-pointer active:scale-[0.98]';
  ...
  return (
    <HintTooltip tip={label}>
      <button
        ...
        disabled={disabled}
        className={cn(
          'absolute top-4 right-4 z-10 inline-flex h-10 w-10 items-center justify-center rounded-full border border-transparent text-muted-foreground hover:text-foreground hover:bg-muted/35 hover:border-border/60 bb-transition disabled:opacity-50 active:scale-95',
          className,
        )}
        aria-label={label}
      >
...
export function ScheduleIconBadge({
  ...
  return (
    <div
      className={cn(
        'inline-flex shrink-0 items-center justify-center rounded-2xl border bb-transition',
