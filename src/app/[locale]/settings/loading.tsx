  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto w-full text-[14px] leading-relaxed bb-enter-fade-up">
      <div className="mb-6 flex items-center gap-3">
        <div className="h-10 w-10 rounded-2xl bg-muted bb-shimmer" />
        ...
        <div className="bb-card p-4 md:p-5 space-y-3">
          ...
          {Array.from({ length: 2 }, (_, index) => (
            <div key={index} className="flex items-center justify-between gap-4 py-2">
              ...
              <div className="h-7 w-12 rounded-full bg-muted bb-shimmer shrink-0" />
            </div>
          ))}
        </div>

        {Array.from({ length: 3 }, (_, index) => (
          <div key={index} className="bb-card p-4 md:p-5 flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-muted bb-shimmer shrink-0" />
            ...
            <div className="h-4 w-4 rounded bg-muted/70 bb-shimmer shrink-0" />
          </div>
        ))}
      </div>
