  ...
  thai_response_templates: {
    ...
    upcoming_maintenance_summary: {
      ...
      format_rules: [
        ...
        '  2) คำแนะนำการซ่อมบำรุงเบื้องต้น — สรุปจาก work_details, recommended_frequency, และ status',
        '  3) วันที่ครบกำหนด (ถ้าคำนวณได้ต้องแสดงทุกบรรทัด) ในรูปแบบ DD-MM-YYYY',
      ],
      urgency_logic: [
      ...
      example_format:
        '• ชื่ออุปกรณ์ — แนะนำ: [คำแนะนำสั้น ๆ จาก work_details] | ครบกำหนด: [DD-MM-YYYY]',
