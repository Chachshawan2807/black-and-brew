...
export const BB_SELECT_TRIGGER_CLASS =
  'relative h-11 w-full appearance-none rounded-2xl border border-border bg-card px-4 pr-10 text-sm font-normal text-foreground bb-shadow-sm bb-transition hover:bg-muted/50 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20 disabled:cursor-not-allowed disabled:opacity-60';
