...
- **Retired (2026-09):** `POST /api/chat`, ToolLoopAgent, external web search, `src/lib/agents/`, `src/lib/ai-data-gateway.ts`, `src/app/actions/tools/`, and chat UI were removed. See **DEC-091**.
