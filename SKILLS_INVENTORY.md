...
> Version: 4.0 | Status: RTK & Master Blueprint Compliant | Format: Zero-Bold Policy Active
...
| Secure Server Auth Gate & Anti-Brute Force | เมื่อเข้าสู่แอปพลิเคชันหรือมีการตรวจสอบสิทธิ์บาริสต้า | ย้ายการยืนยันรหัส PIN 6 หลักไปฝั่ง Server Action ตรวจสอบผ่าน HTTP-only Secure Cookie พร้อมระบบล็อกการป้อนรหัสผิดครบ 5 ครั้ง ป้องกันด้วยคุกกี้/สัญญาล็อก 15 นาที |
